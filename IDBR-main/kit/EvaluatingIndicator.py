...
def top_N(test_u, test_v, test_rate, node_list_u, node_list_v, top_n):
    ...
    for u in test_u:
        recommend_dict[u] = {}
        for v in test_v:
            if node_list_u[u] is None:
                pre = 0
            else:
                U = np.array(node_list_u[u])
                if node_list_v[v] is None:
                    pre = 0
                else:
...
def top_N_by_matrixRate(test_u, test_v, test_rate, matrixRate, top_n):
    recommend_dict = {}
    for u in test_u:
        recommend_dict[u] = {}

        for v in test_v:
            recommend_dict[u][v] = matrixRate[u][v]
...
def top_N_by_matrixRate2(matrix, test_u, test_v, test_rate, matrixRate, top_n):
    recommend_dict = {}
    for u in test_u:
        recommend_dict[u] = {}
